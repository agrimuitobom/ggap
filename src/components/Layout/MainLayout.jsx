    ...
    <div className="flex h-screen bg-gray-100">
      ...
      >
        ...
        <nav>
          ...
          <Link to="/research" className="block py-2.5 px-4 mt-1 rounded transition duration-200 hover:bg-blue-700 text-white">
            📊 研究データ分析
          </Link>
          ...
          <div className="mt-2">
            ...
            {expandedSections.others && (
              <div className="ml-4 mt-1 space-y-1">
                ...
                <Link to="/ppe/checks" className="block py-2 px-4 text-sm rounded transition duration-200 hover:bg-blue-700 text-blue-100">
                  保護具の着用確認
                </Link>
                <Link to="/ppe" className="block py-2 px-4 text-sm rounded transition duration-200 hover:bg-blue-700 text-blue-100">
                  保護具の品目・在庫
                </Link>
          ...
          <div className="mt-2">
            ...
            {expandedSections.organization && (
              <div className="ml-4 mt-1 space-y-1">
                ...
                <Link to="/trash" className="block py-2 px-4 text-sm rounded transition duration-200 hover:bg-blue-700 text-blue-100">
                  🗑 ゴミ箱
                </Link>
