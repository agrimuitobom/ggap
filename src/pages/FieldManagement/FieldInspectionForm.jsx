...
const FieldInspectionForm = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        firestoreLogger.error('圃場点検フォームデータの取得に失敗しました', { organizationId: currentOrganization.id, inspectionId: id }, err);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      firestoreLogger.error('圃場点検記録の保存に失敗しました', { organizationId: currentOrganization?.id, inspectionId: id, fieldId: formData.fieldId }, err);
