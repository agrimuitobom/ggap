...
const pageLogger = createLogger('OrganizationSettings');
...
const OrganizationSettings = () => {
  ...
  const loadMembers = async () => {
    try {
      ...
      pageLogger.error('Error loading members', { organizationId: currentOrganization?.id }, error);
  ...
  const handleUpdateOrganization = async () => {
    try {
      ...
      pageLogger.error('Error updating organization', { organizationId: currentOrganization?.id }, error);
  ...
  const handleInviteMember = async (e) => {
    ...
    try {
      ...
      pageLogger.error('Error inviting member', { organizationId: currentOrganization?.id, inviteRole }, error);
  ...
  const handleRemoveMember = async (userId, userName) => {
    ...
    try {
      ...
      pageLogger.error('Error removing member', { organizationId: currentOrganization?.id, userId }, error);
  ...
  const handleUpdateRole = async (userId, newRole) => {
    try {
      ...
      pageLogger.error('Error updating role', { organizationId: currentOrganization?.id, userId, newRole }, error);
