...
export const createOrganization = async (userId, name, description = '') => {
  try {
    ...
    firestoreLogger.error('Error creating organization', {}, error);
    throw error;
  }
};
  ...
  try {
    ...
    for (const orgId of orgIds) {
      try {
        ...
        firestoreLogger.warn('Failed to fetch organization', { organizationId: orgId, error: err?.message });
      }
    }

    return organizations;
  } catch (error) {
    firestoreLogger.error('Error fetching user organizations', {}, error);
    throw error;
  }
};
...
export const getOrganization = async (organizationId) => {
  try {
    ...
    firestoreLogger.error('Error fetching organization', {}, error);
    throw error;
  }
};
...
export const updateOrganization = async (organizationId, updates) => {
  try {
    ...
    firestoreLogger.error('Error updating organization', {}, error);
    throw error;
  }
};
...
export const deleteOrganization = async (organizationId) => {
  try {
    ...
    firestoreLogger.error('Error deleting organization', {}, error);
    throw error;
  }
};
...
export const addMemberToOrganization = async (organizationId, userId, role = 'member') => {
  try {
    ...
    firestoreLogger.error('Error adding member to organization', {}, error);
    throw error;
  }
};
...
export const removeMemberFromOrganization = async (organizationId, userId) => {
  try {
    ...
    firestoreLogger.error('Error removing member from organization', {}, error);
    throw error;
  }
};
...
export const getOrganizationMembers = async (organizationId) => {
  try {
    ...
    firestoreLogger.error('Error fetching organization members', {}, error);
    throw error;
  }
};
...
export const updateMemberRole = async (organizationId, userId, newRole) => {
  try {
    ...
    firestoreLogger.error('Error updating member role', {}, error);
    throw error;
  }
};
...
export const getUserRoleInOrganization = async (organizationId, userId) => {
  try {
    ...
    firestoreLogger.error('Error fetching user role', {}, error);
    throw error;
  }
};
...
export const acceptInvitation = async (invitationId, userId) => {
  try {
    ...
    firestoreLogger.error('Error accepting invitation', {}, error);
    throw error;
  }
};
...
export const getUserInvitations = async (email) => {
  try {
    ...
    firestoreLogger.error('Error fetching user invitations', {}, error);
    throw error;
  }
};
...
export const migrateUserDataToOrganization = async (userId, organizationId, collections) => {
  try {
    ...
    firestoreLogger.error('Error migrating user data to organization', {}, error);
    throw error;
  }
};
